...
class richtextsAetools {
	...
	public function __construct(ContainerInterface $container) {
		...
		$this->repo = $this->em->getRepository('labo\\Bundle\\TestmanuBundle\\Entity\\richtext');
	}
	...
	public function typeRichtextList() {
		return $this->em->getRepository('labo\\Bundle\\TestmanuBundle\\Entity\\typeRichtext')->findAll();
	}
	...
	public function hasTypeRichtext($typeRichtextNom) {
		if(count($this->em->getRepository('labo\\Bundle\\TestmanuBundle\\Entity\\typeRichtext')->findByNom($typeRichtextNom)) > 0) return true;
			else return false;
	}
