...
class typeImages extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
	private $ord			= 40;			// Ordre de chargement fixtures
	private $entity			= "labo\\Bundle\\TestmanuBundle\\Entity\\typeImage";	// nom de l'entité
	private $container;
	private $manager;
