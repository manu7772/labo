...
// Entité
use labo\Bundle\TestmanuBundle\Entity\pageweb;

class pagewebs extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
	private $ord			= 145;			// Ordre de chargement fixtures
	private $entity			= "labo\\Bundle\\TestmanuBundle\\Entity\\pageweb";	// nom de l'entité
	private $container;
	private $manager;
