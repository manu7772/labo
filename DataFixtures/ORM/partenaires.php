...
class partenaires extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
	private $ord			= 315;			// Ordre de chargement fixtures
	private $entity			= "partenaire";	// nom de l'entité
	private $container;
	private $manager;
